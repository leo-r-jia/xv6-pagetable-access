...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	2a258593          	addi	a1,a1,674 # 1300 <malloc+0xf8>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	27050513          	addi	a0,a0,624 # 1308 <malloc+0x100>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    panic("runcmd");
      ...
      e2:	23250513          	addi	a0,a0,562 # 1310 <malloc+0x108>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	21858593          	addi	a1,a1,536 # 1318 <malloc+0x110>
     108:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     150:	1dc58593          	addi	a1,a1,476 # 1328 <malloc+0x120>
     154:	4509                	li	a0,2
    ...
    break;
     ...
     1e6:	15650513          	addi	a0,a0,342 # 1338 <malloc+0x130>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	dbeb8b93          	addi	s7,s7,-578 # 1360 <malloc+0x158>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	d8c50513          	addi	a0,a0,-628 # 1340 <malloc+0x138>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	ccc60613          	addi	a2,a2,-820 # 1368 <malloc+0x160>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	cbcb0b13          	addi	s6,s6,-836 # 1388 <malloc+0x180>
  ...
  return ret;
     ...
     70a:	c6a50513          	addi	a0,a0,-918 # 1370 <malloc+0x168>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c1050513          	addi	a0,a0,-1008 # 1378 <malloc+0x170>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	bee60613          	addi	a2,a2,-1042 # 1390 <malloc+0x188>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	b86a0a13          	addi	s4,s4,-1146 # 1398 <malloc+0x190>
     81a:	8652                	mv	a2,s4
     81c:	85ce                	mv	a1,s3
     81e:	854a                	mv	a0,s2
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	b5860613          	addi	a2,a2,-1192 # 13a0 <malloc+0x198>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	aba60613          	addi	a2,a2,-1350 # 1368 <malloc+0x160>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	ada60613          	addi	a2,a2,-1318 # 13b8 <malloc+0x1b0>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	a8850513          	addi	a0,a0,-1400 # 13a8 <malloc+0x1a0>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	a9050513          	addi	a0,a0,-1392 # 13c0 <malloc+0x1b8>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	8f060613          	addi	a2,a2,-1808 # 12f8 <malloc+0xf0>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    panic("syntax");
     ...
     a54:	92050513          	addi	a0,a0,-1760 # 1370 <malloc+0x168>
...
0000000000000a60 <main>:
{
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	9d048493          	addi	s1,s1,-1584 # 1468 <buf.1137>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	9c3a0a13          	addi	s4,s4,-1597 # 146b <buf.1137+0x3>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b36:	93650513          	addi	a0,a0,-1738 # 1468 <buf.1137>
