...
00000000000011b2 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    124a:	43a78793          	addi	a5,a5,1082 # 8680 <big.1274>
...
0000000000002236 <bigargtest>:
{
  ...
  close(fd);
    ...
    229e:	2e678793          	addi	a5,a5,742 # 8580 <args.1863>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	3d668693          	addi	a3,a3,982 # 8678 <args.1863+0xf8>
    ...
    22be:	2c658593          	addi	a1,a1,710 # 8580 <args.1863>
